...
# No need to perform the brew update, plugin brew-updates does this
# on a refresh it is a race to lock and I found brew-updates loosing and error
# so, just let that plugin do the update, it executes more frequently
